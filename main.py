...
bg_music.play(loops=-1).set_volume(0.15)

#  Groups
player = pygame.sprite.GroupSingle()
player.add(Player()) # noqa
...
game_name = font.render('Pixel Runner', False, (111, 169, 196))
game_name_rect = game_name.get_rect(center=(400, 65))

game_message = font.render('Press space to run', False, (111, 169, 196))
...
while True:
    for event in pygame.event.get():
        ...
        if game_active:
            if event.type == obstacle_timer:
                obstacle_group.add(Obstacle(choice(['fly', 'snail', 'snail', 'snail']))) # noqa
    ...
    if game_active:
        ...
        score_intro_surf = font.render(f'Score: {score}', False, (111, 169, 196))
